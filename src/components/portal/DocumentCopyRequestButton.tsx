...
export default function DocumentCopyRequestButton({
  documentId,
  documentNo,
  documentTitle,
  sourceNo,
  ...
  return (
    <div className={compact ? "inline-flex flex-col gap-1" : "space-y-2"}>
      ...
      <ConfirmationDialog
        isOpen={isDialogOpen}
        title="Solicitar copia del documento"
        description={`Se enviará una petición de copia para ${documentTitle || documentNo || documentId}. El equipo revisará la solicitud y te contactará si necesita más información.`}
