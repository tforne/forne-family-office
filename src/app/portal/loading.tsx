export default function PortalLoading() {
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="ffo-portal-card w-full max-w-xl rounded-[34px] p-8">
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            ...
            <div className="mt-6 space-y-3">
              <div className="ffo-portal-skeleton h-3 w-11/12 rounded-full" />
              <div className="ffo-portal-skeleton h-3 w-9/12 rounded-full" />
              <div className="ffo-portal-skeleton h-3 w-10/12 rounded-full" />
            </div>
          </div>
        </div>
      </div>
